...
def most_sucessful(df, sport):
    ...
    x.columns = ['Name', 'count']  # Rename to match 'left_on' and 'right_on' in merge
    x = x.merge(df, left_on='Name', right_on='Name', how='left')[['Name', 'count', 'Sport', 'region']].drop_duplicates(
        'Name')
...
def yearwise_medal_tally(df, country):
    temp_df = df.dropna(subset=['Medal'])
    temp_df.drop_duplicates(subset=['Team', 'NOC', 'Year', 'Games', 'City', 'Sport', 'Event', 'Medal'],
                            inplace=True)
